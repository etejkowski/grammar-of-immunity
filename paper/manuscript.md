...
**Background.** Current T-cell receptor (TCR) specificity predictors perform reasonably on epitopes represented during training but fail to generalize to previously unseen epitopes [4–6]. One proposed explanation is that existing receptor representations ignore biologically meaningful organization created during V(D)J recombination [1,2]. We tested that prediction.
